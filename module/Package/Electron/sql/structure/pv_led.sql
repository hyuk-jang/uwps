...
-- 테이블 pv_led.battery_data 구조 내보내기
CREATE TABLE IF NOT EXISTS `battery_data` (
  `inverter_data_seq` mediumint(9) NOT NULL COMMENT '인버터 데이터 시퀀스',
  `inverter_seq` mediumint(9) NOT NULL COMMENT '인버터 정보 시퀀스',
  `battery_vol` int(11) DEFAULT NULL COMMENT '배터리 저압',
  `battery_a` int(11) DEFAULT NULL COMMENT '배터리 전류',
  `battery_charging_w` int(11) DEFAULT NULL COMMENT '배터리 충전 전력',
  `battery_discharging_w` int(11) DEFAULT NULL COMMENT '배터리 방전 전력',
  `battery_total_charging_wh` int(11) DEFAULT NULL COMMENT '배터리 누적 충전 전력',
  `battery_total_discharging_wh` int(11) DEFAULT NULL COMMENT '배터리 누적 방전 전력',
  `writedate` datetime NOT NULL COMMENT '등록일',
  PRIMARY KEY (`inverter_data_seq`,`inverter_seq`),
  KEY `FK_inverter_TO_battery_data` (`inverter_seq`),
  CONSTRAINT `FK_inverter_TO_battery_data` FOREIGN KEY (`inverter_seq`) REFERENCES `inverter` (`inverter_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='인버터에서 측정된 데이터';

-- 테이블 데이터 pv_led.battery_data:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `battery_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `battery_data` ENABLE KEYS */;
...
-- 테이블 pv_led.input_data 구조 내보내기
CREATE TABLE IF NOT EXISTS `input_data` (
  `inverter_data_seq` mediumint(9) NOT NULL COMMENT '인버터 데이터 시퀀스',
  `inverter_seq` mediumint(9) NOT NULL COMMENT '인버터 정보 시퀀스',
  `input_line_w` int(11) DEFAULT NULL COMMENT '입력 라인 전력',
  `input_total_line_wh` int(11) DEFAULT NULL COMMENT '계통 충전 전체 누적',
  `writedate` datetime NOT NULL COMMENT '등록일',
  PRIMARY KEY (`inverter_data_seq`,`inverter_seq`),
  KEY `FK_inverter_TO_input_data` (`inverter_seq`),
  CONSTRAINT `FK_inverter_TO_input_data` FOREIGN KEY (`inverter_seq`) REFERENCES `inverter` (`inverter_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='인버터에서 측정된 데이터';

-- 테이블 데이터 pv_led.input_data:~0 rows (대략적) 내보내기
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='인버터 장치 상세 정보';
...
CREATE TABLE IF NOT EXISTS `inverter_data` (
  ...
  `lf` int(11) NOT NULL COMMENT '주파수',
  ...
  `operation_has_v` tinyint(4) DEFAULT NULL COMMENT '계통 전압 여부',
...
-- 테이블 데이터 pv_led.inverter_data:~0 rows (대략적) 내보내기
...
-- 테이블 pv_led.led_data 구조 내보내기
CREATE TABLE IF NOT EXISTS `led_data` (
  `inverter_data_seq` mediumint(9) NOT NULL COMMENT '인버터 데이터 시퀀스',
  `inverter_seq` mediumint(9) NOT NULL COMMENT '인버터 정보 시퀀스',
  `led_dc_v` int(11) DEFAULT NULL COMMENT 'LED DC 전압',
  `led_dc_a` int(11) DEFAULT NULL COMMENT 'LED DC 전류',
  `led_using_w` int(11) DEFAULT NULL COMMENT 'LED 사용 전력',
  `led_total_using_wh` int(11) DEFAULT NULL COMMENT 'LED 누적 소모 전력',
  `writedate` datetime NOT NULL COMMENT '등록일',
  PRIMARY KEY (`inverter_data_seq`,`inverter_seq`),
  KEY `FK_inverter_TO_led_data` (`inverter_seq`),
  CONSTRAINT `FK_inverter_TO_led_data` FOREIGN KEY (`inverter_seq`) REFERENCES `inverter` (`inverter_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='인버터에서 측정된 데이터';

-- 테이블 데이터 pv_led.led_data:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `led_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `led_data` ENABLE KEYS */;
